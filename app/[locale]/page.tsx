    ...
    <div className="relative min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center">
          <div className="pt-[16%] max-w-6xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <GlassCard>
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    <p className="text-xs text-gray-300 font-semibold">{t('services.aiAgents.stat1')}</p>
                  </div>
                </GlassCard>
                ...
                <GlassCard>
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    <p className="text-xs text-gray-300 font-semibold">{t('services.sales.impact')}</p>
                  </div>
                </GlassCard>
                ...
                <GlassCard>
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    <p className="text-xs text-gray-300 font-semibold">{t('services.customerService.caseStudy')}</p>
                  </div>
                </GlassCard>
                ...
                <GlassCard>
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    <p className="text-xs text-gray-300 font-semibold">{t('services.development.impact')}</p>
                  </div>
                </GlassCard>
                ...
                <GlassCard>
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    <p className="text-xs text-gray-300 font-semibold">{t('services.marketing.stat')}</p>
                  </div>
                </GlassCard>
                ...
                <GlassCard>
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    <p className="text-xs text-gray-300 font-semibold">{t('services.operations.caseStudy')}</p>
                  </div>
                </GlassCard>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <GlassCard className="bg-gray-900/10 backdrop-blur-md">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-400/20">
                    ...
                    <p className="text-xs text-gray-400">{t('common.useAI')}</p>
                  </div>
                </GlassCard>
                ...
                <GlassCard className="bg-gray-900/10 backdrop-blur-md">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-400/20">
                    ...
                    <p className="text-xs text-gray-400">{t('problem.leadership.stat')}</p>
                  </div>
                </GlassCard>
                ...
                <GlassCard className="bg-gray-900/10 backdrop-blur-md">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-400/20">
                    ...
                    <p className="text-xs text-gray-400">{t('problem.speed.stat')}</p>
                  </div>
                </GlassCard>
              </div>
            </div>
              ...
              <GlassCard>
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="p-4">
                    ...
                    <p className="text-sm text-gray-400">{t('cta.stats.industry')}</p>
                  </div>
                  <div className="p-4">
                    <p className="text-3xl font-bold text-white mb-2">44%</p>
                    <p className="text-sm text-gray-400">{t('cta.stats.adoption')}</p>
                  </div>
                  <div className="p-4">
                    <p className="text-3xl font-bold text-white mb-2">1.5x</p>
                    <p className="text-sm text-gray-400">{t('cta.stats.growth')}</p>
                  </div>
                </div>
            ...
            <GlassCard>
              <div className="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Monterrey, Nuevo León, México</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-3 text-gray-300">{t('footer.services')}</h4>
                  <ul className="text-sm text-gray-500 space-y-2 hover:*:text-gray-300">
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-gray-300">{t('footer.company')}</h4>
                  <ul className="text-sm text-gray-500 space-y-2 hover:*:text-gray-300">
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-gray-300">{t('footer.contact')}</h4>
                  <ul className="text-sm text-gray-500 space-y-2 hover:*:text-gray-300">
